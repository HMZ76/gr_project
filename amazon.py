...
class AmazonItemDataset(Dataset):
    ...
    def __init__(
        self,
        root: str = "../genrec/dataset/amazon",
        split: str = "beauty",
        train_test_split: str = "all",
        encoder_model_name: str = "../genrec/model_hubs/sentence-transformers/sentence-t5-base",
    ...
    def __getitem__(self, idx: int) -> List[float]:
        return torch.tensor(self.embeddings[idx].tolist())
...
class AmazonSeqDataset(Dataset):
    ...
    def __init__(
        ...
        pretrained_rqvae_path: str = "/opt/data/private/hmz/rec/genrec/out/tiger/amazon/beauty/rqvae/checkpoint_epoch_4999.pt",
        encoder_model_name: str = "../genrec/model_hubs/sentence-transformers/sentence-t5-base",
    ...
    def __getitem__(self, idx: int):
        ...
        return (user_id, item_sem_ids, target_sem_ids)
    
if __name__ == "__main__":
    dataset = AmazonSeqDataset("../../genrec/dataset/amazon", "beauty", "train", 50, 5)
    print(len(dataset))
    print(dataset[0])
